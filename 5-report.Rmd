...
Both _R_~H~ (the variable of primary interest, but many fewer measurements) and _R_~S~ (which incorporates both _R_~H~ and belowground autotrophic respiration) exhibit highly significant trends over time relative to three of the four different GPP and SIF data sources. The one exception is GOME2 SIF, the shortest (2004-2013) dataset.
